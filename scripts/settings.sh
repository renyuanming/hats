...
if [[ "$CLUSTER_NAME" == "" ]]; then
    ...
    Servers=("node12" "node13" "node14" "node15" "node17" "node18" "node19" "node20" "node21" "node22" "node37" "node39" "node40" "node41" "node42" "node43" "node45" "node46" "node47" "node48")
    ServersIP=("192.168.10.22" "192.168.10.23" "192.168.10.24" "192.168.10.25" "192.168.10.27" "192.168.10.28" "192.168.10.29" "192.168.10.30" "192.168.10.31" "192.168.10.32" "192.168.10.47" "192.168.10.49" "192.168.10.50" "192.168.10.51" "192.168.10.52" "192.168.10.53" "192.168.10.55" "192.168.10.56" "192.168.10.57" "192.168.10.58")
    # Clients=("proj18" "proj19")
    # ClientsIP=("192.168.10.118" "192.168.10.119")
    Clients=("proj18")
    ClientsIP=("192.168.10.118")
