...
if [[ "$CLUSTER_NAME" == "" ]]; then
    ...
    Servers=("node11" "node12" "node13" "node14" "node15" "node16" "node17" "node18" "node19" "node20")
    ServersIP=("192.168.10.21" "192.168.10.22" "192.168.10.23" "192.168.10.24" "192.168.10.25" "192.168.10.26" "192.168.10.27" "192.168.10.28" "192.168.10.29" "192.168.10.30")
