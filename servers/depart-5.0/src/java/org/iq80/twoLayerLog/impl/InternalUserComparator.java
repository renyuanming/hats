        ...
        implements UserComparator, Serializable
{
            ...
            Slice limit)
    {
        ...
        //if (internalKeyComparator.getUserComparator().compare(startUserKey.copySlice(), shortestSeparator.copySlice()) < 0) {
    ...
    public Slice findShortSuccessor(Slice key)
    {
        ...
        //if (internalKeyComparator.getUserComparator().compare(userKey.copySlice(), shortSuccessor.copySlice()) < 0) {
