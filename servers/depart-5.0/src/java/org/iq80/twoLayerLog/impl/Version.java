...
import static org.iq80.twoLayerLog.impl.DbConstants.MAX_MEM_COMPACT_LEVEL;
...
import static org.iq80.twoLayerLog.impl.VersionSet.MAX_GRAND_PARENT_OVERLAP_BYTES;
        ...
        implements SeekingIterable<InternalKey, Slice>, Serializable
{
    ...
    public Version(VersionSet versionSet)
    {
        ...
        this.level0 = new Level0(getTableCache(), getInternalKeyComparator(), versionSet.filesID);
    ...
    List<FileMetaData> getLevel0FileMeta(){
    ...
    public LookupResult get(LookupKey key)
    {
        ...
        //System.out.println("group file number:" + level0.getFiles().size());
    ...
    public void addFile(int level, FileMetaData fileMetaData)
    {
        if (level == 0) {
            ...
            //StorageService.instance.printInfo("level:"+level+"level0 size:"+level0.getFiles().size());
        }
    }
