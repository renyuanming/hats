...
public enum Stage
{
    ...
    HATS             (true,  "SchedulingStage",         "request",  DatabaseDescriptor::getConcurrentSchedulers,        DatabaseDescriptor::setConcurrentSchedulers,        Stage::multiThreadedLowSignalStage),
