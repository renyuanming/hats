...
import org.apache.cassandra.hats.HatsUtils.AKLogLevels;
...
public class StatsComponent
{
    ...
    public static StatsComponent load(Descriptor descriptor, MetadataType... types) throws IOException
    {
        ...
        {
            HatsUtils.printStackTace(AKLogLevels.ERROR, String.format("HATSERROR: load file %s ERROR: %s", descriptor.fileFor(Components.STATS), e));
