...
import org.apache.cassandra.hats.net.GossipStatesDigest;
import org.apache.cassandra.hats.net.GossipStatesDigestVerbHandler;
import org.apache.cassandra.hats.net.PolicyReplicate;
import org.apache.cassandra.hats.net.PolicyReplicateVerbHandler;
import org.apache.cassandra.hats.net.RequestNewStates;
import org.apache.cassandra.hats.net.RequestNewStatesVerbHandler;
import org.apache.cassandra.hats.net.SendNewStates;
import org.apache.cassandra.hats.net.SendNewStatesVerbHandler;
import org.apache.cassandra.hats.net.StatesGathering;
import org.apache.cassandra.hats.net.StatesGatheringSignal;
import org.apache.cassandra.hats.net.StatesGatheringSignalVerbHandler;
import org.apache.cassandra.hats.net.StatesGatheringVerbHandler;
...
public enum Verb
{
    ...
    STATE_GATHERING_REQ        (201,  P3, writeTimeout,    HATS,             () -> StatesGathering.serializer,           () -> StatesGatheringVerbHandler.instance,       STATE_GATHERING_RSP            ),
    STATE_GATHERING_SIGNAL_RSP (202,  P1, writeTimeout,    REQUEST_RESPONSE,  () -> NoPayload.serializer,                 () -> ResponseVerbHandler.instance                                              ),
    STATE_GATHERING_SIGNAL_REQ (203,  P1, writeTimeout,    HATS,             () -> StatesGatheringSignal.serializer,     () -> StatesGatheringSignalVerbHandler.instance, STATE_GATHERING_SIGNAL_RSP     ),
    POLICY_REPLICATE_RSP       (204,  P1, writeTimeout,    REQUEST_RESPONSE,  () -> NoPayload.serializer,                 () -> ResponseVerbHandler.instance                                              ),
    POLICY_REPLICATE_REQ       (205,  P1, writeTimeout,    HATS,             () -> PolicyReplicate.serializer,           () -> PolicyReplicateVerbHandler.instance,       POLICY_REPLICATE_RSP           ),
    GOSSIP_STATES_DIGEST_RSP   (206,  P1, writeTimeout,    REQUEST_RESPONSE,  () -> NoPayload.serializer,                 () -> ResponseVerbHandler.instance                                              ),
    GOSSIP_STATES_DIGEST_REQ   (207,  P1, writeTimeout,    HATS,             () -> GossipStatesDigest.serializer,        () -> GossipStatesDigestVerbHandler.instance,    GOSSIP_STATES_DIGEST_RSP       ),
    GOSSIP_STATES_ACK_RSP      (208,  P1, writeTimeout,    REQUEST_RESPONSE,  () -> NoPayload.serializer,                 () -> ResponseVerbHandler.instance                                              ),
    GOSSIP_STATES_ACK_REQ      (209,  P1, writeTimeout,    HATS,             () -> SendNewStates.serializer,           () -> SendNewStatesVerbHandler.instance,       GOSSIP_STATES_ACK_RSP          ),
    GOSSIP_STATES_ACK2_RSP     (210,  P1, writeTimeout,    REQUEST_RESPONSE,  () -> NoPayload.serializer,                 () -> ResponseVerbHandler.instance                                              ),
    GOSSIP_STATES_ACK2_REQ     (211,  P1, writeTimeout,    HATS,             () -> RequestNewStates.serializer,          () -> RequestNewStatesVerbHandler.instance,      GOSSIP_STATES_ACK2_RSP         ),
