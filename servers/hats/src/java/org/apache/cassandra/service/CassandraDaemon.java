...
import org.apache.cassandra.hats.HatsUtils;
import org.apache.cassandra.hats.Scheduler;
...
public class CassandraDaemon
{
    ...
    private static volatile boolean isHatsActived = false;
    ...
    public boolean getIsHatsActived()
    {
        return isHatsActived;
    }

    public void activeHats()
    {
        if(!isHatsActived)
        {            
            ...
            else
            {
                ...
                {
                    ElectionBootstrap.initElection(HatsUtils.getRaftLogPath(), 
                                                "ElectSeeds", 
    ...
    private void loadMetadataForHats() {
