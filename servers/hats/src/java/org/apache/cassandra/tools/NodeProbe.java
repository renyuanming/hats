...
public class NodeProbe implements AutoCloseable
{
    ...
    public void setHats(String enableHats, String step_size, String offload_threshold, String recovery_threshold) {
        ssProxy.setHats(enableHats, step_size, offload_threshold, recovery_threshold);
    }
