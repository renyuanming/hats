...
public class GlobalStates implements Serializable {
    ...
    public static Double[] translatePolicyForBackgroundController(InetAddressAndPort targetNode)
    {
        ...
        logger.debug("rymDebug: The read count of each replica is {}, the total read count of the node is {}", Arrays.toString(readCountOfEachReplica), totalReadCountOfTheNode);
