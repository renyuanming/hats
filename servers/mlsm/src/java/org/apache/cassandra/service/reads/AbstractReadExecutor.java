...
public abstract class AbstractReadExecutor
{
    ...
    private void makeRequests(ReadCommand readCommand, Iterable<Replica> replicas)
    {
        ...
        // logger.info("HATSInfo: Making requests to replicas. The replicas are: {}, replicaplan size is : {}, replica plan is {}, consistency level is {}", replicas, this.replicaPlan().contacts().size(), this.replicaPlan().contacts().endpointList(), this.replicaPlan().consistencyLevel());
