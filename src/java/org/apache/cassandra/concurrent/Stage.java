...
public enum Stage
{
    ...
    HORSE             (true,  "SchedulingStage",         "request",  DatabaseDescriptor::getConcurrentSchedulers,        DatabaseDescriptor::setConcurrentSchedulers,        Stage::multiThreadedLowSignalStage),
