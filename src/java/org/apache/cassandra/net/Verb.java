...
import org.apache.cassandra.horse.net.PolicyDistributeVerbHandler;
...
public enum Verb
{
    ...
    POLICY_DISTRIBUTE_RSP        (204,  P1, writeTimeout,    REQUEST_RESPONSE,  () -> NoPayload.serializer,                 () -> ResponseVerbHandler.instance                             ),
    POLICY_DISTRIBUTE_REQ        (205,   P1, writeTimeout,    HORSE,          () -> PolicyDistribute.serializer,                  () -> PolicyDistributeVerbHandler.instance,      POLICY_DISTRIBUTE_RSP     ),
